...
```{r featurePlot,dependson="trainingTest",fig.height=4,fig.width=4}
...
```{r age-wage,dependson="trainingTest",fig.height=4,fig.width=6}
...
```{r age-wage-clr-jobclass,dependson="trainingTest",fig.height=4,fig.width=6}
...
```{r age-wage-clr-edu,dependson="trainingTest",fig.height=4,fig.width=6}
...
```{r diagnostics,dependson="modelFit",fig.height=5,fig.width=5}
