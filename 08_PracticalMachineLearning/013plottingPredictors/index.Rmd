...
```{r featurePlot-example,dependson="trainingTest",fig.height=4,fig.width=4}
library(caret)
...
```{r qplot-example,dependson="trainingTest",fig.height=4,fig.width=6}
library(ISLR); library(ggplot2); library(caret); library(gridExtra);
...
```{r qplot-with-color-example,dependson="trainingTest",fig.height=4,fig.width=6}
...
```{r qplot-with-smoothers-example,dependson="trainingTest",fig.height=4,fig.width=6}
...
```{r cut2-boxplot-example,dependson="cut2plot",fig.height=4,fig.width=6,cache=TRUE}
...
```{r cut2-boxplot-with-points-example,dependson="cut2plot",fig.height=4,fig.width=9}
...
```{r cut2-tables-example,dependson="cut2",fig.height=4,fig.width=9}
...
```{r density-example,dependson="trainingTest",fig.height=4,fig.width=6}
