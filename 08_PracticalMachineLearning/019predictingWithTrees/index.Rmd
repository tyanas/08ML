...
```{r iris-qplot, dependson="trainingTest",fig.height=4,fig.width=6}
...
```{r iris-fit, dependson="createTree", fig.height=4.5, fig.width=4.5}
...
```{r iris-fit-fancy, dependson="createTree", fig.height=4.5, fig.width=4.5}
library(rattle)
