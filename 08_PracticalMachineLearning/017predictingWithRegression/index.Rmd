...
```{r eruption,dependson="faith",fig.height=4,fig.width=4, out.width=400}
...
```{r model-fit,dependson="faithlm",fig.height=4,fig.width=4}
plot(trainFaith$waiting,trainFaith$eruptions,pch=19,col="blue",xlab="Waiting",ylab="Duration")
...
```{r train-test-plot,dependson="faithlm",fig.height=4,fig.width=8}
par(mfrow=c(1,2))
plot(trainFaith$waiting,trainFaith$eruptions,pch=19,col="blue",xlab="Waiting",ylab="Duration")
...
```{r intervals,dependson="faithlm",fig.height=4,fig.width=4}
